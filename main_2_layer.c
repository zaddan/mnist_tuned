...
extern int MNIST_MAX_TRAINING_IMAGES; 

/// Define number datasets (images+labels) in the TEST file/s
extern int MNIST_MAX_TESTING_IMAGES; 
...
int main(int argc, const char * argv[]) {
    ...
    LayerDefinition *layerDefs = setLayerDefinitions(numberOfLayers, inputLayer, outputLayer);
    ...
    MNIST_MAX_TRAINING_IMAGES = atoi(argv[8]); 
    MNIST_MAX_TESTING_IMAGES = atoi(argv[9]); 
